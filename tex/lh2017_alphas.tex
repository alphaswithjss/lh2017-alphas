...
%
In the case of $e^+e^-$ event shapes, operator definitions of soft matrix elements allow for field theoretic definitions of the non-perturbative parameters.
%
...
%
From the theoretical side, it introduces the need for non-perturbative track functions.
%
