...
\abstract{
Recent advances in precision jet substructure have introduced a new class of observables that are amenable to calculations with formal accuracy beyond the precision of parton shower programs.  These higher order calculations have introduced the possibility to extract the strong coupling constant $\alpha_s$ from the radiation pattern within a jet.  We perform a proof-of-principle sensitivity test to demonstrate the suitability of such measurements to add useful information to the existing precision extractions of $\alpha_s$.   Using a simplified approach, we show that a measurement of $\alpha_s$ with an approximate 10\% uncertainty may be possible at the Large Hadron Collider.  This result motivates a complete analysis with a full set of experimental and theoretical considerations.
}
...
%%==============
\section{Observables Sensitive to $\alpha_s$}
\label{sec:jetmass}
%%==============
