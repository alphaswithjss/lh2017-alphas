...
public:
  ...
  double alphas(double log_kt, bool allow_freezing=false) const;
  ...
  double delta_kt_line(double alpha, double Ltop, double Lbot, double B) const;
  ...
  double kt_triangle(double alpha, double Ltop, double Lbot, double B) const;
  ...
  double triangle(double alpha, double beta, double Ltop, double Lbot, double B) const;

  /// the R' corresponding to the bottom-line of the triangle
  double triangle_prime(double alpha, double beta, double Ltop, double Lbot, double B) const;
